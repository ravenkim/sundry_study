...
const PreviewPanel: React.FC<EditorPreviewProps & Partial<ButtonEditorState>> = (
  ...
  if ("styles" in props) {
    const { styles } = props as ButtonEditorState;
          ...
          <div className="flex flex-col">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-2 items-center">
                ...
                <ButtonPreview styles={styles} disabled />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap gap-6 justify-center">
              <div className="flex flex-col gap-2 items-center">
                ...
                <ButtonPreview styles={styles} size="sm" />
              </div>
              <div className="flex flex-col gap-2 items-center">
                <p className="text-xs text-muted-foreground">Default</p>
                <ButtonPreview styles={styles} size="default" />
              </div>
              <div className="flex flex-col gap-2 items-center">
                <p className="text-xs text-muted-foreground">Large</p>
                <ButtonPreview styles={styles} size="lg" />
              </div>
              <div className="flex flex-col gap-2 items-center">
                <p className="text-xs text-muted-foreground">Icon</p>
                <ButtonPreview styles={styles} size="icon" label="+" />
              </div>
            </div>
          </div>
        </div>
