...
import { TabsTrigger, Tabs, TabsList, TabsContent } from 'src/shared/lib/shadcn/components/ui/tabs'
    ...
    return (
        ...
        >
            <Tabs defaultValue="lazytable" className="">
                ...
                <TabsContent value="lazytable"><ProductsLazyScrollTable/></TabsContent>

                <TabsContent value="table"><ProductsTable/></TabsContent>
