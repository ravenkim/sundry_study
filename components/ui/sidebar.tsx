  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group peer hidden md:block text-sidebar-foreground transition-width duration-200 w-[var(--sidebar-width)]",
          state === "collapsed" && "w-0"
        )}
        data-state={state}
      ...
      >
        <div
          className={cn(
            "duration-200 sticky top-0 hidden w-[var(--sidebar-width)] transition-[width,transform] ease-linear md:flex",
            side === "left"
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "transition-[margin] ease-linear duration-200",
