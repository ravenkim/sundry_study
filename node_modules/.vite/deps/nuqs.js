...
// node_modules/.pnpm/nuqs@2.4.1_react-router@7.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1__react@18.3.1/node_modules/nuqs/dist/chunk-6YKAEXDW.js
...
// node_modules/.pnpm/nuqs@2.4.1_react-router@7.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1__react@18.3.1/node_modules/nuqs/dist/index.js
...
function useQueryState(key, {
  ...
  const queryRef = (0, import_react.useRef)((initialSearchParams == null ? void 0 : initialSearchParams.get(key)) ?? null);
  const [internalState, setInternalState] = (0, import_react.useState)(() => {
    const queuedQuery = getQueuedValue(key);
    const query = queuedQuery === void 0 ? (initialSearchParams == null ? void 0 : initialSearchParams.get(key)) ?? null : queuedQuery;
  ...
  debug(
    ...
    key,
    internalState,
    (initialSearchParams == null ? void 0 : initialSearchParams.get(key)) ?? null
  );
  (0, import_react.useEffect)(() => {
    const query = (initialSearchParams == null ? void 0 : initialSearchParams.get(key)) ?? null;
  ...
  }, [initialSearchParams == null ? void 0 : initialSearchParams.get(key), key]);
  (0, import_react.useEffect)(() => {
...
function useQueryStates(keyMap, {
  ...
  const resolvedUrlKeys = (0, import_react.useMemo)(
    () => Object.fromEntries(
  ...
  const outputState = (0, import_react.useMemo)(
