...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._calculate_event_properties = function (event_name, event_properties, timestamp, uuid) {
        ...
        if (this.sessionManager) {
            var _c = this.sessionManager.checkAndGetSessionAndWindowId(), sessionId = _c.sessionId, windowId = _c.windowId;
        ...
        try {
            ...
            properties['$sdk_debug_retry_queue_size'] = (_b = (_a = this._retryQueue) === null || _a === void 0 ? void 0 : _a['queue']) === null || _b === void 0 ? void 0 : _b.length;
        }
        catch (e) {
